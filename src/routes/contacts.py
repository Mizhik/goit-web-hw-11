...
from src.dtos.dto import ContactResponse, ContactSchema

router = APIRouter(prefix="/contacts", tags=["contants"])
...
async def search_contacts(
    ...
    contacts = await repositories_contacts.search_contacts(filters, limit, offset, db)
    if contacts is None:
